...
#5000 sequences 
#		 	-2021.07.07 4920 seqs (0)
# 2021.08.07-2021.10.14 4817 seqs (1)
# 2021.10.15-2021.11.21 4830 seqs (2)
# 2021.11.22-2021.12.23 4809 seqs (3)
# 2021.12.24-2022.01.19 4912 seqs (4)
# 2022.01.20-2022.02.15 4604 seqs (5)
# 2022.02.16-2022.03.17 4928 seqs (6)
# 2022.03.18-2022.04.25 4919 seqs (7)
# 2022.04.26-2022.06.23 4977 seqs (8)
# 2022.06.24-2022.08.31 4854 seqs (9)
# 2022.09.01-2022.10.30 4945 seqs (10)
# 2022.10.31-- (11)

#set local computer here!
local = ["zoliq", "morpholino", "faculty"][1]
if local == "zoliq":
	os.chdir("/Volumes/zoliq data/Downloads/covid_seq")
else:
	os.chdir(os.path.expanduser("~/Downloads/covid_seq"))
